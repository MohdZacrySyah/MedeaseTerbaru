    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-brand">
            <a href="{{ route('dashboard') }}" data-turbo-scroll="false">
                ...
                <div class="brand-subtitle">Sistem Informasi Kesehatan</div>
            </a>
        </div>

        <a href="{{ route('profil') }}" class="user-profile" data-turbo-scroll="false">
            ...
            <div class="user-info">
                <h4 class="text-truncate">{{ Auth::user()?->name ?? 'Pasien' }}</h4>
                <p><i class="fas fa-circle"></i> Lihat Profil Saya</p>
            </div>
        </a>
