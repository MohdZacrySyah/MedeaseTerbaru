...
<head>
    ...
    <title>Verifikasi OTP - Praktek Bersama</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&display=swap" rel="stylesheet">
    
    {{-- Salin CSS dari file login/register Anda --}}
    <style>
...
<body>
    ...
    <div class="login-wrapper">
        <div class="login-illustration">
            ...
            <h1 class="illustration-title">Verifikasi Akun</h1>
            <p class="illustration-subtitle">
                Kami telah mengirimkan 6 digit kode OTP ke email Anda. Masukkan kode tersebut untuk melanjutkan.
            </p>
        </div>
        ...
        <div class="login-form-container">
            ...
            <form method="POST" action="{{ route('password.verify.otp') }}">
                ...
                {{-- Email tersembunyi, diambil dari session flash --}}
                <input type="hidden" name="email" value="{{ $email ?? old('email') }}">
                
                <div class="form-group">
                    <label for="otp" class="form-label">Kode OTP (6 Digit)</label>
                    <div class="input-wrapper">
                        <input id="otp" type="text" name="otp" class="form-input" inputmode="numeric" pattern="\d{6}" maxlength="6" required autofocus>
            ...
            <p class="form-footer-text">
                Tidak menerima kode? 
                <a href="{{ route('password.request') }}" class="form-footer-link">Kirim ulang</a>
            </p>
        </div>
    </div>
